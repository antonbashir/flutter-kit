...
class CustomExpansionTile extends StatefulWidget {
  ...
  /// the [leading], [row], [subtitle] and [trailing] widgets. It does not inset
  ...
  /// will be used for the [row] and [subtitle]. Otherwise, defaults to [ColorScheme.primary] color.
  ///
  /// See also:
  ///
  /// * [ExpansionTileTheme.of], which returns the nearest [ExpansionTileTheme]'s
  ...
  /// [TextTheme.bodyLarge] will be used for the [row] and [subtitle]. Otherwise,
